...
namespace Panda_Racing
{
    public partial class RacingForm : Form
    {
        ...
        private void SetupRaceTrack()
        {
            ...
            punters[2] = pFactory.getPunter("Amritpreet", MaximumBet, AmritpreetBet); //getting Amritpreet object from factory class
        ...
        private void AmritpreetButton_CheckedChanged(object sender, EventArgs e)
        {
